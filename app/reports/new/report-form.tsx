...
const AMMOS_LIST = [
  ...
  { value: "СВП ТЕРМОБАР 2.5", label: "СВП ТЕРМОБАР 2.5" },
  { value: "БНПП 40", label: "БНПП 40" },
  { value: "ПФМ КРИЛО", label: "ПФМ КРИЛО" },
  { value: "КУ-0.8", label: "КУ-0.8" },
  { value: "Бочка 2.1", label: "Бочка 2.1" },
  { value: "Сфера 1.1", label: "Сфера 1.1" },
  { value: "Терміт 1.4", label: "Терміт 1.4" },
  { value: "Фугас 6.0", label: "Фугас 6.0" },
  { value: "УЯУ-6.0", label: "УЯУ-6.0" }
];
