...
const DRONE_TYPES = [
  ...
  { value: "UAV Baton – Analogue Day Bird (Безпілотний літальний апарат Батон Аналог день)", label: "Баражуючий дрон \"Батон\"" },
...
const TARGET_TYPES = [
  ...
  { value: "Антена зв'язку", label: "Антена зв'язку" },
  ...
  { value: "ворожий РЕБ", label: "ворожий РЕБ" },
  { value: "БТР", label: "БТР" },
  { value: "БМП", label: "БМП" },
  { value: "Танк", label: "Танк" },
  { value: "Гармата", label: "Гармата" },
  { value: "Міномет", label: "Міномет" }
];
